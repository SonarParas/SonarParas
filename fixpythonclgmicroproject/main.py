...
if __name__ == "__main__" :
	...
	enterTask = Label(gui, text = "Enter Your Task", bg = "orangered")
	...
	Submit = Button(gui, text = "Submit", fg = "black", bg = "lime", command = insertTask)

	# create a text area for the root
	# with lunida 13 font
	# text area is for writing the content
	TextArea = Text(gui, height = 5, width = 25, font = "lucida 13", fg = "black", bg = "lavender")

	# create a label : Delete Task Number
	taskNumber = Label(gui, text = "Delete Task Number", bg = "yellow")
						
	taskNumberField = Text(gui, height = 1, width = 2, font = "lucida 13", fg = "silver", bg = "black")
	...
	DevelopP = Label(gui, text = "Developed By:", bg = "floralwhite")
	Pars = Label(gui, text = "Paras Yashwant Sonar", bg = "silver")
	ParsEnroll = Label(gui, text = "Enrollment no:200610015", bg = "violet")
	...
	DevelopP.grid(row = 10, column = 2, ipadx = 50)
	Pars.grid(row = 11, column = 2, ipadx = 50)
	ParsEnroll.grid(row = 12, column = 2, ipadx = 50)
